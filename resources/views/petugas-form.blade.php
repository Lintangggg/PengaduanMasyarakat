        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('proses-edit-petugas', ['id' => $petugas->id]) }}" method="POST" class="form-container">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" id="password" name="password" value="{{ $petugas->password }}" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="role" name="role" required>
                                ...
                                <option value="sosial" {{ $petugas->role === 'sosial' ? 'selected' : '' }}>Sosial</option>
                                <option value="infrastruktur" {{ $petugas->role === 'infrastruktur' ? 'selected' : '' }}>Infrastruktur</option>
                            </select>
                        </div>
